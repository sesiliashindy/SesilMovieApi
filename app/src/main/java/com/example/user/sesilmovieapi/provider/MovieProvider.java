package com.example.user.sesilmovieapi.provider;
...
import com.example.user.sesilmovieapi.service.CleanupJobService;
...
public class MovieProvider extends ContentProvider {
    ...
    private static final int CLEANUP_JOB_ID = 44;
