package com.example.user.sesilmovieapi.api;

import android.net.Uri;

import com.example.user.sesilmovieapi.BuildConfig;
...
public class MovieApi {
    ...
    public static URL getSearch(String query){
        //api.themoviedb.org/3/search/movie?api_key={API KEY}&language=en-US&query={MOVIE NAME}
        Uri uri = Uri.parse(BASE_URL).buildUpon()
                .appendPath(SEARCH)
                .appendPath(MOVIE)
                .appendQueryParameter(PARAM_API_KEY,API_KEY)
